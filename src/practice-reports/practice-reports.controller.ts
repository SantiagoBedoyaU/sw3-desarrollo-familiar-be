...
export class PracticeReportsController {
  constructor(private readonly practiceReportsService: PracticeReportsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updatePracticeReportDto: UpdatePracticeReportDto) {
